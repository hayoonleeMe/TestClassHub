...
namespace ClassHub.Server.Controllers
{
    namespace ClassHub.Server.Controllers
    {
        ...
        {
            private const string CLASSHUB_CODESUBMIT_INSERT = "https://testclasshub.azurewebsites.net/api/CodeSubmit/insert";
            private const string CLASSHUB_CODESUBMIT_UPDATE = "https://testclasshub.azurewebsites.net/api/CodeSubmit/update";
            private const string CLASSHUB_CODESUBMIT_FAIL = "https://testclasshub.azurewebsites.net/api/CodeSubmit/fail";
            private const string JUDGESERVER_ADDRESS = "http://20.200.208.227:5000/Judge";
